...
const navigationConfig: NavigationTree[] = [
...

    {
        ...
        subMenu: [
           ...
           {
            key: 'admin.pay.trainer',
            path: '/admin/accounting/trainer-salary',
            title: 'حقوق و تسویه مربیان',
            translateKey: 'nav.admin.payments',
            icon: 'wallet',
            type: NAV_ITEM_TYPE_ITEM,
            authority: ['ADMIN'],
    ...
    },
    {
        ...
        subMenu: [
            {
                key: 'trainer.students.classes',
                path: '/trainer/students/classes',
                title: 'لیست کلاس ها',
                translateKey: 'nav.trainer.students.classes',
                icon: 'class',
                type: NAV_ITEM_TYPE_ITEM,
                authority: ['TRAINER'],
                subMenu: [],
            ...
            {
                key: 'trainer.students.sessions',
                path: '/trainer/students/sessions',
                title: 'لیست شاگردان ',
                translateKey: 'nav.trainer.students.sessions',
                icon: 'session',
                type: NAV_ITEM_TYPE_ITEM,
                authority: ['TRAINER'],
                subMenu: [],

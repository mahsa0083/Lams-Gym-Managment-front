                ...
                <div className="absolute left-0 z-50 mt-3 w-56 rounded-2xl border border-slate-200 bg-white py-2 text-slate-700 shadow-2xl dir-rtl">
                    ...
                    <div className="border-t border-slate-100 pt-1">
                        ...
                        <button
                            ...
                            className="flex w-full cursor-pointer items-center gap-2.5 px-4 py-2 text-right text-xs text-red-600 transition-colors hover:bg-red-50"
                        >
